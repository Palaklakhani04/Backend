...
const ActionButtons = ({ setRenderData, setOpen }) => {
  const {
  ...
  } = buttonLogicService(setRenderData, setOpen);

  const buttonData = [
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: handleUpdateBookByName, value: "Update By Name" },
        { color: "success", variant: "contained", onClick: handleUpdateBookByNameAndAuthor, value: "Update By Name And Author" },
        { color: "success", variant: "contained", onClick: handleDeleteBookById, value: "Delete By Book Id" },
        { color: "success", variant: "contained", onClick: handleDeleteBookByName, value: "Delete By Book Name" },
        { color: "success", variant: "contained", onClick: handleDeleteBookByDescAndAuthor, value: "Delete By Book Desc and Author" },
      ],
    },
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: handleDeleteBookByNameAndCategory, value: "Delete By Book Name And Category" },
        { color: "success", variant: "contained", onClick: showAll, value: "Show All" },
      ],
    },
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: handleShowBookById, value: "Show Book By Id" },
        { color: "success", variant: "contained", onClick: handleShowBookByName, value: "Show Book By Name" },
        { color: "success", variant: "contained", onClick: handleShowBookByNameAndAuthor, value: "Show Book By Name And Author" },
        { color: "success", variant: "contained", onClick: showBookPagesMoreThan100, value: "Show Book pages more than 100" },
      ],
    },
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: showBookPagesLessThan90MoreThan25, value: "Show book pages less than 90 More than 25" },
        { color: "success", variant: "contained", onClick: showBookPagesLessThan90MoreThan25Not80, value: "Show book pages less than 90 More than 25 but not 80" },
        { color: "success", variant: "contained", onClick: showBookWith0Page, value: "Show Book pages zero" },
      ],
    },
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: showBookByReleaseYear, value: "Show book released year 2001 and 2015" },
        { color: "success", variant: "contained", onClick: sortByName, value: "Sort By Book Name" },
        { color: "success", variant: "contained", onClick: sortByBookPrice, value: "Sort By Book Price" },
        { color: "success", variant: "contained", onClick: sortByBookAuthor, value: "Sort By Book Author" },
        { color: "success", variant: "contained", onClick: sortByNoOfPages, value: "Sort By Books No of Pages" },
      ],
    },
    {
      divStyle: "flex items-center justify-start gap-2",
      buttons: [
        { color: "success", variant: "contained", onClick: sortByBookCategory, value: "Sort By Book Category" },
        { color: "success", variant: "contained", onClick: sortByReleaseYear, value: "Sort By Book Released Year" },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      {dialogData.map((dialog, index) => (
        ...
        >
          <DialogTitle>Get Book By Id</DialogTitle>
